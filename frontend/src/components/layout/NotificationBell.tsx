...
export const NotificationBell: React.FC = () => {
  ...
  const getBadgeText = () => {
    ...
    return unreadCount > 10 ? '10+' : unreadCount.toString();
  };
  ...
  return (
    <div className="relative" ref={bellRef}>
      ...
      >
        ...
        {badgeText && (
          <span className="absolute top-1 right-1 flex items-center justify-center min-w-[1.25rem] h-5 px-1 text-[10px] font-bold text-white bg-teal-500 rounded-full border-2 border-white">
            {badgeText}
          </span>
        )}
      </button>
